...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.9\textwidth}{
        \centering
        \textbf{Azure CLI - Création du Resource Group}\\[0.3cm]
        \texttt{az group create --name fraud-detection-rg --location westeurope}\\[0.2cm]
        \texttt{"provisioningState": "Succeeded"}
    }}
    \caption{Commande Azure CLI pour la création des ressources}
\end{figure}
